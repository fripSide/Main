...
void InitVertex();
void TestDraw(Shader &s1, Shader &s2);
...
int main() {
	...
	Shader shader2("shader/shader2.vs", "shader/shader2.fs");
...
void TestDraw(Shader &s1, Shader &s2) {
	...
	-0.5f,  0.5f, -0.5f,  0.0f, 1.0f
		...
		s2.use();
		s2.setInt("texture1", 0);
		s2.setInt("texture2", 1);
		isInit = true;
	}
	...
	for (unsigned int i = 0; i < 10; i++)
	{
		...
		s2.setMat4("mvp", projection * view * model);
